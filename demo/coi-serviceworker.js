 ...
 * on hosts that don't allow custom response headers (e.g. GitHub Pages). numbl
 * uses SharedArrayBuffer for cooperative cell interruption; without cross-origin
 * isolation the Stop button can't stop a running cell.
 *
...
if (typeof window === "undefined") {
  ...
  self.addEventListener("fetch", event => {
    ...
    // internal flags, which breaks cross-origin fetch requests (e.g. numbl
    // downloading the mip package manager from its GitHub release).
